...
class _RespuestaCardState extends State<RespuestaCard> {
  ...
  Future<void> _reportarRespuesta() async {
    final motivoController = TextEditingController();
    final confirmar = await showDialog<bool>(
      context: context,
      builder: (_) => AlertDialog(
        title: const Text('Reportar respuesta'),
        content: Column(
          mainAxisSize: MainAxisSize.min,
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            const Text('Cuéntanos brevemente qué pasa con esta respuesta.'),
  ...
  Future<void> _bloquearUsuaria() async {
    final nombre = widget.respuesta.usuario;
    final confirmar = await showDialog<bool>(
      context: context,
      builder: (_) => AlertDialog(
