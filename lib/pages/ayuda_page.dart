    ...
    items: [
      ...
      _HelpItem(
        ...
        respuesta:
            ...
            'Además, junto al puesto de cada una hay una flechita ▲▼ que indica '
            'si ha subido o bajado puestos desde el último recálculo (cada '
            'pocas horas) — un guion "—" significa que se mantiene igual o que '
            'aún no hay datos suficientes para calcularlo. Funciona igual en '
            'cualquier división, sea la tuya o una que solo estés mirando.\n\n'
