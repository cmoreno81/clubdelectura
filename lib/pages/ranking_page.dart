  ...
  Widget build(
    ...
    return Scaffold(
      ...
      body: FutureBuilder<Ranking>(
        ...
        final cementerio =
            ranking.masAbandonados.isNotEmpty
  ...
  child: Padding(
    ...
    child: Column(
      ...
      children: [
        ...
        Text(
          '${reina.total} libros finalizados',
        ),
      ],
    ),
  ),
  ...
  child: Padding(
    ...
    child: Column(
      ...
      children: [
        ...
        Text(
          '${libroClub.media.toStringAsFixed(2)} ⭐',
        ),

        Text(
          '${libroClub.votos} valoraciones',
        ),
      ],
    ),
  ),
